...
SaplingBlockController.prototype.show = function(req, res) {
  ...
  this.getSaplingBlocks(req.params.height, blockQty, function(err, result) {
    if (err) {
...
SaplingBlockController.prototype.getSaplingBlocks = function(height, blockQty, callback) {
